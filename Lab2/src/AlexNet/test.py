...
def print_statistics(stats, model_condition):
    ...
    print(f"\n[RESULTS] ALEXNET-SNOUTNET {model_condition.upper()} MODEL TESTING RESULTS")
    print("="*70)
...
def main():
    """Main testing function for AlexNet"""
    
    # Parse command line arguments
    parser = argparse.ArgumentParser(description='Test AlexNet-SnoutNet model')
    ...
    print(f"Testing AlexNet-SnoutNet on device: {device}")
