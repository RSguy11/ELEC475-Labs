...
def print_statistics(stats, model_condition):
    ...
    print(f"\n[RESULTS] SNOUTNET {model_condition.upper()} MODEL TESTING RESULTS")
    print("="*70)
...
def main():
    """Main testing function for SnoutNet"""
    ...
    print(f"Testing SnoutNet on device: {device}")
    ...
    if model is None:
        print(f"No trained SnoutNet model found! Please train the model first.")
        return
